...
export default function BookingModal({ school, onClose }) {
  ...
  return (
    /* 1. Backdrop - Justerad för att centrera på desktop men ligga i botten/fullt på mobil */
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4 text-slate-900">
      {/* 2. Modal-container - h-[100dvh] fixar mobilglappet */}
      <div className="bg-white w-full h-[100dvh] sm:h-auto sm:max-h-[90vh] sm:max-w-xl sm:rounded-[3rem] shadow-2xl overflow-hidden relative flex flex-col animate-in fade-in slide-in-from-bottom-10 duration-300">
        ...
        {/* 4. CONTENT - Scrollbart område för formuläret */}
        <form
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-4 bg-slate-50 rounded-2xl outline-none border-2 font-bold text-sm ${errors.personalId ? "border-red-200 focus:ring-red-500" : "border-transparent focus:ring-blue-600"}`}
                  onChange={(e) =>
        ...
        {/* 5. FOOTER - Alltid synlig i botten */}
        <div className="p-6 md:p-10 border-t border-slate-100 bg-white shrink-0 z-20 pb-10 sm:pb-10">
          <button
            ...
            className="w-full bg-blue-600 text-white py-5 rounded-[1.5rem] font-black uppercase italic tracking-tighter text-lg hover:bg-slate-900 transition-all shadow-xl shadow-blue-100 flex items-center justify-center gap-2 disabled:bg-slate-100 disabled:text-slate-300 disabled:shadow-none"
          >
            {isSubmitting ? (
              <>
